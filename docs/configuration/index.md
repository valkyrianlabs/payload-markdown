...
:::card[Styling]{href="/configuration/styling"}
Tailwind setup, wrapper classes, typography variants, and deprecated class aliases.
:::

:::card[Directive Themes]{href="/configuration/directive-themes"}
...
:::callout[Keep namespaces separate]{variant="warning"}
