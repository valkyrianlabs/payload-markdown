...
navTitle: TOC
description: Generate a table of contents from headings in the current Markdown document.
order: 230
status: published
tags:
  - directives
...
Place `:::toc` after the H1 and introductory paragraph on long reference pages:
